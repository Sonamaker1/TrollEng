...
/* 
	...
	public static function load():Void
	{
		...
		/*
		if (nextState == PlayState || nextState == states.editors.ChartingState){
	...
	override function update(elapsed)
	{
		...
		switch (step){
			...
			case 1:
				...
				#elseif sys
				var waitTime:Float = (nextState == PlayState || nextState == states.editors.ChartingState) ? 0 : Math.max(0, 1.6 - (startTime - Sys.cpuTime()));
				#else
				var waitTime:Float = 0;
				#end
